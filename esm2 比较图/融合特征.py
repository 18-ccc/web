...
# 三种菌的性能指标数据（GCN 与 ESM2+GCN）
data_dict = {
    '肠杆菌': {
        '仅GCN特征': [0.929, 0.8688, 0.8908, 0.9606],
        'ESM2+GCN融合特征': [0.9414, 0.929, 0.9407, 0.9819]
    },
    '铜绿假单胞菌': {
        '仅GCN特征': [0.9404, 0.8314, 0.8594, 0.9572],
        'ESM2+GCN融合特征': [0.9667, 0.9602, 0.9665, 0.9923]
    },
    '鲍曼不动杆菌': {
        '仅GCN特征': [0.9794, 0.7143, 0.75, 0.9913],
        'ESM2+GCN融合特征': [0.9962, 0.9978, 0.9962, 0.9999]
    }
}
