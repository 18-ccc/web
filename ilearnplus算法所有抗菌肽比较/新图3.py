...
# 特征名称与指标数据（修改为新的数据）
metrics = {
    '50个特征':  [0.8961, 0.8961, 0.8959, 0.9546],
    '60个特征':  [0.9016, 0.9016, 0.9014, 0.9579],
    '70个特征':  [0.9058, 0.9058, 0.9056, 0.9599],
    '80个特征':  [0.9070, 0.9070, 0.9069, 0.9589],
    '90个特征':  [0.9095, 0.9095, 0.9094, 0.9588],
    '92个特征':  [0.9095, 0.9095, 0.9094, 0.9588]
}
