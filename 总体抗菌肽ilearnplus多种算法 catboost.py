...
# 要合并的特征文件名称（仅这5个）
selected_files = ["aac.xlsx", "apaac.xlsx", "paac.xlsx", "pseaac.xlsx", "qso.xlsx"]
...
rf.fit(X, y)
top_features = pd.Series(rf.feature_importances_, index=X.columns).nlargest(50).index.tolist()
